...
export const categories: Category[] = [
  ...
  },
  {
    ...
    pageDesc: 'Extract text from images and PDFs using Scribe OCR — 12+ languages, 100% in your browser.',
    heading: 'OCR Tools',
    subheading: 'Extract text from images and PDFs using Scribe OCR — runs entirely in your browser, no uploads.',
    ...
    tools: [
      {
        ...
        pageDesc: 'Extract text from any image or PDF using Scribe OCR. Supports 12+ languages — runs 100% in your browser.',
      },
    ],
  },
  {
