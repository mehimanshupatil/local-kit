          ...
          {duration > 0 && (
            <div className="card p-5 space-y-5">
              ...
              <div className="flex items-center gap-3">
                <Button variant="secondary" onClick={() => seekTo(start)} className="p-2" title="Jump to start">
                  <SkipBack className="w-4 h-4" />
                </Button>

                <Button onClick={togglePlay} className="px-5 py-2">
                  {playing ? <Pause className="w-5 h-5" /> : <Play className="w-5 h-5" />}
                </Button>

                <Button variant="secondary" onClick={() => seekTo(end)} className="p-2" title="Jump to end">
              ...
              <div className="flex gap-3">
                <Button onClick={trim} disabled={status === 'processing'} className="flex-1 justify-center py-3">
